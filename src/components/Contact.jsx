...
const Contact = () => {
    const contactItems = [
        ...
        },
        {
            ...
            content: (
                <p className='text-gray-600'>
                  WhatsApp: <a href="#" className='hover:text-pink-600'>+62 812-3892-8001</a>    
                </p>
            )      
        },
        {
            ...
            content: (
                <p className='text-gray-600'>
                  Alamat Email: <a href="#" className='hover:text-pink-600'>Dindabeautycare@gmail.com</a>    
                </p>
            )      
        },
        {
      ...
      <header data-aos="fade-up" data-aos-delay="400" className='text-center mb-16 relative'>
        ...
        bg-pink-100 opacity-30 z-0'>  {/* <- pverbaikan typo -trasnlate-x-1/2 */}
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto relative z-10'>
            Punya pertanyaan seputar perawatan atau ingin booking treatment? kami dengan senang hati membantu. Yuk hubungi Dinda Beauty Care sekarang!
          </p>
      </header>
          <main className='flex flex-col lg:flex-row gap-12'>
            ...
            <section data-aos='fade-up' data-aos-delay='600' className='lg:w-3/5'>
             <div className='bg-white rounded-2xl shadow-xl p-8 h-full'>
              <h2 className='text-2xl font-bold text-gray-800 mb-6'>Kirim Pertanyaan Anda</h2>
