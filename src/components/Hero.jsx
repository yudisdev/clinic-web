      ...
      >
        <article className="container mx-auto px-4 py-14 md:py-20 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 ">
            <hgroup data-aos="fade-up" data-aos-duration="2000">
              <h1 className="text-4xl md:text-5xl ld:text-6xl font-bold text-gray-800 mb-4 ">
                ...
                {/*tingkatkan kecantikan alami anda*/}
              </h1>
              <p className="text-lg text-gray-600 mb-8 max-w-lg">
                Dapatkan alis yang rapi, natural, dan tahan lama dengan teknik
                sulam alis profesional. Bikin penampilanmu makin percaya diri
                setiap hari.
              </p>
            </hgroup>
            <nav
            ...
            <aside data-aos="fade-up" data-aos-duration="3000" className="py-4">
